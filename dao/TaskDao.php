                ...
                class TaskDao implements metodos
                {
                  /*********************Método para extraer todoas la tareas*************************************************************/
                    ...
                    public function create($task)
                    {
                        $instance = Connecion::getInstance();
                        $conn = $instance->getCnx();
                        $sql = sprintf("insert into tasks (tasks, date_task) values('%s','%s')",$task->getTask(),$task->getDateTask());
                    ...
                    public function update($task)
                    {
                        $instance = Connecion::getInstance();
                        $conn = $instance->getCnx();
                        $sql = sprintf("update tasks set tasks='%s', date_task='%s' where id='%s'",$task->getTask(),$task->getDateTask(),$task->getId());
                        if ($conn->query($sql))
                        {
                            $conn->close();
                            return true;
